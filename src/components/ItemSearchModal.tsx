...
export default function ItemSearchModal({slot, is_open, equiped_item, set_is_open, edit_equiped_item}: {
        slot: number,
        is_open: boolean, 
        equiped_item: Item[],
    ...
    const [is_item_select, set_is_item_select] = useState<boolean>(selected_item.Id !== 0);
    useEffect(() => {
